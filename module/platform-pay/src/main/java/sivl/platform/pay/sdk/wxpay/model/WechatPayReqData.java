package sivl.platform.pay.sdk.wxpay.model;
...
public class WechatPayReqData {
	...
	public WechatPayReqData(PaymentsModel payment){
		...
		setNotify_url(Configure.getBack_url());
		if(StringUtil.isNotEmpty(payment.getOpenId())){
